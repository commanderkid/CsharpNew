...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
            string siteLinq = textBox1.Text;
            Ping ping = new Ping();
            label2.Text = ping.Send(siteLinq).RoundtripTime.ToString();

            }
            catch (Exception)
            {
                MessageBox.Show("client does not respond");
            }
        }
    }
}
...
namespace WindowsFormsApp1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "The Latency is:";
            // 
            // label2
            // 
            ...
            this.textBox1.Text = "The Link name";
            // 
            // button1
            // 
